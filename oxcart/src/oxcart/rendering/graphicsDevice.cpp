...
void GraphicsDevice::createSurface() { m_Window.createWindowSurface(m_Instance, &m_Surface); }
...
void GraphicsDevice::populateDebugMessengerCreateInfo(
...
void GraphicsDevice::transitionImageLayout(VkImage image, VkFormat format,
...
VkImageView GraphicsDevice::createImageView(VkImage image, VkFormat format) {
...
void GraphicsDevice::createImage(uint32_t width, uint32_t height,VkFormat format,
