#ifndef RENDERING_WINDOW_HEADER
#define RENDERING_WINDOW_HEADER
...
private:
	RenderingWindow() : Window(L"Oxcart 3D", L"OpenGLCanvas", 1280, 720) {};
	static RenderingWindow* m_Instance;
	unsigned int m_VAO;
	unsigned int m_VBO;
